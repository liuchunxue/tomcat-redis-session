...
public class RedisSessionManager extends ManagerBase implements Lifecycle {
    ...
    @Override public int getRejectedSessions() {
    ...
    @Override public void load() throws ClassNotFoundException, IOException {

    }

    @Override public void unload() throws IOException {
    ...
    @Override public void addLifecycleListener(LifecycleListener listener) {
        handlerValve.addLifecycleListener(listener);
    }
     ...
     */
    @Override public LifecycleListener[] findLifecycleListeners() {
        return handlerValve.findLifecycleListeners();
    }
    ...
    @Override public void removeLifecycleListener(LifecycleListener listener) {
        handlerValve.removeLifecycleListener(listener);
    }
    ...
    @Override public Session createSession(String requestedSessionId) {
    ...
    @Override public Session createEmptySession() {
    ...
    protected boolean saveInternal(Jedis jedis, Session session, boolean forceSave) throws IOException {
        ...
        try {
            ...
            if (forceSave || redisSession.isDirty() || null == (isCurrentSessionPersisted = this.currentSessionIsPersisted.get()) || !isCurrentSessionPersisted || !Arrays
                    .equals(originalSessionAttributesHash, (sessionAttributesHash = serializer.attributesHashFrom(redisSession)))) {
    ...
    @Override public void remove(Session session, boolean update) {
        Jedis jedis = null;
        Boolean error = true;
    ...
    @Override public void processExpires() {
